...
class Victory:
	def initGlobals(self):
		...
		riseFall = CyRiseFall()
		provPalestine = riseFall.getProvince(riseFall.findRFCProvince("PROVINCE_PALESTINE"))
		provPhoenicia = riseFall.getProvince(riseFall.findRFCProvince("PROVINCE_PHOENICIA"))
		provUpperEgypt = riseFall.getProvince(riseFall.findRFCProvince("PROVINCE_UPPER EGYPT"))
		provLowerEgypt = riseFall.getProvince(riseFall.findRFCProvince("PROVINCE_LOWER EGYPT"))
		provNubia = riseFall.getProvince(riseFall.findRFCProvince("PROVINCE_NUBIA"))
		provSumer = riseFall.getProvince(riseFall.findRFCProvince("PROVINCE_SUMER"))
		provAkkad = riseFall.getProvince(riseFall.findRFCProvince("PROVINCE_AKKAD"))
		provSubartu = riseFall.getProvince(riseFall.findRFCProvince("PROVINCE_SUBARTU"))
		provKhuzestan = riseFall.getProvince(riseFall.findRFCProvince("PROVINCE_KHUZESTAN"))
		provAfrica = riseFall.getProvince(riseFall.findRFCProvince("PROVINCE_AFRICA"))
		provCyprus = riseFall.getProvince(riseFall.findRFCProvince("PROVINCE_CYPRUS"))
		provSouthernIberia = riseFall.getProvince(riseFall.findRFCProvince("PROVINCE_SOUTHERN IBERIA"))
		provPersia = riseFall.getProvince(riseFall.findRFCProvince("PROVINCE_PERSIA"))
		provPeloponnese = riseFall.getProvince(riseFall.findRFCProvince("PROVINCE_PELOPONNESE"))
		provAttica = riseFall.getProvince(riseFall.findRFCProvince("PROVINCE_ATTICA"))
		provMacedonia = riseFall.getProvince(riseFall.findRFCProvince("PROVINCE_MACEDONIA"))
		provCentralGreece = riseFall.getProvince(riseFall.findRFCProvince("PROVINCE_CENTRAL GREECE"))
		provEuboea = riseFall.getProvince(riseFall.findRFCProvince("PROVINCE_EUBOEA"))
		provCyclades = riseFall.getProvince(riseFall.findRFCProvince("PROVINCE_CYCLADES"))
		provAnatolia = riseFall.getProvince(riseFall.findRFCProvince("PROVINCE_ANATOLIA"))
