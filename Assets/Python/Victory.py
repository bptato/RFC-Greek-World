...
class Victory:
	def initGlobals(self):
		...
		provUpperEgypt = riseFall.getProvince(riseFall.findProvince("PROVINCE_UPPER EGYPT"))
		provLowerEgypt = riseFall.getProvince(riseFall.findProvince("PROVINCE_LOWER EGYPT"))
		...
		provSouthernIberia = riseFall.getProvince(riseFall.findProvince("PROVINCE_SOUTHERN IBERIA"))
		...
		provCentralGreece = riseFall.getProvince(riseFall.findProvince("PROVINCE_CENTRAL GREECE"))
