...
class Victory:
	def initGlobals(self):
		...
		riseFall = CyRiseFall()
		provPalestine = riseFall.getRFCProvince(riseFall.findRFCProvince("PROVINCE_PALESTINE"))
		provPhoenicia = riseFall.getRFCProvince(riseFall.findRFCProvince("PROVINCE_PHOENICIA"))
		provUpperEgypt = riseFall.getRFCProvince(riseFall.findRFCProvince("PROVINCE_UPPER EGYPT"))
		provLowerEgypt = riseFall.getRFCProvince(riseFall.findRFCProvince("PROVINCE_LOWER EGYPT"))
		provNubia = riseFall.getRFCProvince(riseFall.findRFCProvince("PROVINCE_NUBIA"))
		provSumer = riseFall.getRFCProvince(riseFall.findRFCProvince("PROVINCE_SUMER"))
		provAkkad = riseFall.getRFCProvince(riseFall.findRFCProvince("PROVINCE_AKKAD"))
		provSubartu = riseFall.getRFCProvince(riseFall.findRFCProvince("PROVINCE_SUBARTU"))
		provKhuzestan = riseFall.getRFCProvince(riseFall.findRFCProvince("PROVINCE_KHUZESTAN"))
		provAfrica = riseFall.getRFCProvince(riseFall.findRFCProvince("PROVINCE_AFRICA"))
		provCyprus = riseFall.getRFCProvince(riseFall.findRFCProvince("PROVINCE_CYPRUS"))
		provSouthernIberia = riseFall.getRFCProvince(riseFall.findRFCProvince("PROVINCE_SOUTHERN IBERIA"))
		provPersia = riseFall.getRFCProvince(riseFall.findRFCProvince("PROVINCE_PERSIA"))
		provPeloponnese = riseFall.getRFCProvince(riseFall.findRFCProvince("PROVINCE_PELOPONNESE"))
		provAttica = riseFall.getRFCProvince(riseFall.findRFCProvince("PROVINCE_ATTICA"))
		provMacedonia = riseFall.getRFCProvince(riseFall.findRFCProvince("PROVINCE_MACEDONIA"))
		provCentralGreece = riseFall.getRFCProvince(riseFall.findRFCProvince("PROVINCE_CENTRAL GREECE"))
		provEuboea = riseFall.getRFCProvince(riseFall.findRFCProvince("PROVINCE_EUBOEA"))
		provCyclades = riseFall.getRFCProvince(riseFall.findRFCProvince("PROVINCE_CYCLADES"))
		provAnatolia = riseFall.getRFCProvince(riseFall.findRFCProvince("PROVINCE_ANATOLIA"))
