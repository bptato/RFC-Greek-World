#This script was taken from this mod: https://github.com/YggdrasiI/PBStats/tree/master/PB Mod_v9.
#It's probably a modified version of this project: https://github.com/simplejson/simplejson
#Point is, the script is not my work.
...
class JSONEncoder(object):
	...
	def _newline_indent(self):
		return '\n' + ('\t' * (self.indent * self.current_indent_level)) #bluepotato: tabs as indentation
...
def scanstring(s, end, encoding=None, _b=BACKSLASH, _m=STRINGCHUNK.match):
	...
	while 1:
		...
		if content:
			...
			ncontent = str(content.encode(encoding))
			_append(ncontent)
		if terminator == '"':
			break
		try:
