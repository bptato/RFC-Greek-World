...
void CyRiseFallInterface()
{
	...
	python::class_<CyRFCPlayer>("CyRFCPlayer")
		...
		.def("scheduleUnit", &CyRFCPlayer::scheduleUnit, "void (int year, int unitID, int x, int y, int unitAI, int facingDirection, int amount = 1)")
		.def("scheduleCity", &CyRFCPlayer::scheduleCity, "void (int year, int x, int y, int population = 1)")
