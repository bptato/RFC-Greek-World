...
m_bStabilityVassalBonus(false),
m_bStabilityFoundBonus(false),
m_bStabilityConquestBonus(false),
m_bStabilityCommerceBonus(false),
//bluepotato end
...
void CvCivicInfo::read(FDataStreamBase* stream)
{
	...
	//bluepotato start (from Rhye)
	stream->Read(&m_bStabilityVassalBonus);
	stream->Read(&m_bStabilityFoundBonus);
	stream->Read(&m_bStabilityConquestBonus);
	stream->Read(&m_bStabilityCommerceBonus);
	//bluepotato end
...
void CvCivicInfo::write(FDataStreamBase* stream)
{
	...
	//bluepotato start (from Rhye)
	stream->Write(m_bStabilityVassalBonus);
	stream->Write(m_bStabilityFoundBonus);
	stream->Write(m_bStabilityConquestBonus);
	stream->Write(m_bStabilityCommerceBonus);
	//bluepotato end
...
bool CvCivicInfo::read(CvXMLLoadUtility* pXML)
{
	...
	//bluepotato start (from Rhye)
	pXML->GetChildXmlValByName(&m_bStabilityVassalBonus, "bStabilityVassalBonus");
	pXML->GetChildXmlValByName(&m_bStabilityFoundBonus, "bStabilityFoundBonus");
	pXML->GetChildXmlValByName(&m_bStabilityConquestBonus, "bStabilityConquestBonus");
	pXML->GetChildXmlValByName(&m_bStabilityCommerceBonus, "bStabilityCommerceBonus");
	//bluepotato end
...
//bluepotato start
std::wstring CvCivilizationInfo::getRFCID() const {
	return RFCID;
}

void CvCivilizationInfo::setPlayable(bool playable) {
	m_bPlayable = playable;
}

void CvCivilizationInfo::setAIPlayable(bool playable) {
	m_bAIPlayable = playable;
}
//bluepotato end
...
bool CvCivilizationInfo::read(CvXMLLoadUtility* pXML)
{
	...
	//bluepotato start
	pXML->GetChildXmlValByName(RFCID, "RFCID");
	//bluepotato end
...
bool CvVictoryInfo::isHistorical() const
{
	return historical;
}
...
bool CvVictoryInfo::read(CvXMLLoadUtility* pXML)
{
	...
	pXML->GetChildXmlValByName(&historical, "bHistorical");
...
//bluepotato start
int CvLeaderHeadInfo::getLeaderReign() const {
	return leaderReign;
}
//bluepotato end
...
void CvLeaderHeadInfo::read(FDataStreamBase* stream)
{
	...
	//bluepotato start: leader swapping
	stream->Read(&leaderReign);
	//bluepotato end
...
bool CvLeaderHeadInfo::read(CvXMLLoadUtility* pXML)
{
	...
	//bluepotato start: leader swapping
	pXML->GetChildXmlValByName(&leaderReign, "LeaderReign");
	//bluepotato end
