...
public:
	...
	CvUnit* initUnit(UnitTypes eUnit, int iX, int iY, UnitAITypes eUnitAI = NO_UNITAI, DirectionTypes eFacingDirection = NO_DIRECTION, int maintenanceCost=0/*bluepotato*/);							// Exposed to Python
...
/************************************************************************************************/
	...
	void setCivics(CivicOptionTypes eIndex, CivicTypes eNewValue, bool startingCivics = false); //bluepotato: starting civics															// Exposed to Python
