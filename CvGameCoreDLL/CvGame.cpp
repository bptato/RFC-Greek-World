...
void CvGame::setAIAutoPlay(int iNewValue)
{
	...
	if (iOldValue != iNewValue)
	{
		...
		{
			//bluepotato start: free up slots for first civs
...
bool CvGame::testVictory(VictoryTypes eVictory, TeamTypes eTeam, bool* pbEndScore) const
{
	...
	//bluepotato start: historical victories
	if(bValid) {
		if(GC.getVictoryInfo(eVictory).isHistorical()) {
			bValid = false;
		}
	}
	//bluepotato end
