...
void CyEnumsPythonInterface()
{
	...
	python::enum_<WidgetTypes>("WidgetTypes")
		...
		.value("WIDGET_WB_CITY_NAME", WIDGET_WB_CITY_NAME)
		.value("WIDGET_WB_SETTLER_MAP", WIDGET_WB_SETTLER_MAP)
	...
	python::enum_<ButtonPopupTypes>("ButtonPopupTypes")
		...
		//bluepotato start
		.value("BUTTONPOPUP_CITY_NAME", BUTTONPOPUP_CITY_NAME)
		//bluepotato end
	...
	python::enum_<CivilizationTypes>("CivilizationTypes")
		...
		.value("CIVILIZATION_EGYPT", CIVILIZATION_EGYPT)
		.value("CIVILIZATION_SUMERIA", CIVILIZATION_SUMERIA)
		.value("CIVILIZATION_INDUS_VALLEY", CIVILIZATION_INDUS_VALLEY)
		.value("CIVILIZATION_ELAM", CIVILIZATION_ELAM)
		.value("CIVILIZATION_MINOA", CIVILIZATION_MINOA)
		.value("CIVILIZATION_PHOENICIA", CIVILIZATION_PHOENICIA)
		.value("CIVILIZATION_BABYLON", CIVILIZATION_BABYLON)
		.value("CIVILIZATION_HITTITE", CIVILIZATION_HITTITE)
		.value("CIVILIZATION_MYCENAE", CIVILIZATION_MYCENAE)
		.value("CIVILIZATION_ASSYRIA", CIVILIZATION_ASSYRIA)
		.value("CIVILIZATION_ISRAEL", CIVILIZATION_ISRAEL)
		.value("CIVILIZATION_ATHENS", CIVILIZATION_ATHENS)
		.value("CIVILIZATION_SPARTA", CIVILIZATION_SPARTA)
		.value("CIVILIZATION_SCYTHIA", CIVILIZATION_SCYTHIA)
		.value("CIVILIZATION_CARTHAGE", CIVILIZATION_CARTHAGE)
		.value("CIVILIZATION_CELT", CIVILIZATION_CELT)
		.value("CIVILIZATION_ETRURIA", CIVILIZATION_ETRURIA)
		.value("CIVILIZATION_CELTIBERIA", CIVILIZATION_CELTIBERIA)
		.value("CIVILIZATION_NUBIA", CIVILIZATION_NUBIA)
		.value("CIVILIZATION_PERSIA", CIVILIZATION_PERSIA)
		.value("CIVILIZATION_ROME", CIVILIZATION_ROME)
		.value("CIVILIZATION_MACEDONIA", CIVILIZATION_MACEDONIA)
		.value("CIVILIZATION_INDIA", CIVILIZATION_INDIA)
		.value("CIVILIZATION_BACTRIA", CIVILIZATION_BACTRIA)
		.value("CIVILIZATION_NUMIDIA", CIVILIZATION_NUMIDIA)
		.value("CIVILIZATION_GERMANIA", CIVILIZATION_GERMANIA)
		.value("CIVILIZATION_SASSANID", CIVILIZATION_SASSANID)
		.value("CIVILIZATION_BYZANTIUM", CIVILIZATION_BYZANTIUM)
		.value("CIVILIZATION_HUNS", CIVILIZATION_HUNS)
		.value("CIVILIZATION_INDEPENDENT", CIVILIZATION_INDEPENDENT)
		.value("CIVILIZATION_INDEPENDENT2", CIVILIZATION_INDEPENDENT2)
	...
	python::enum_<ControlTypes>("ControlTypes")
		...
		.value("CONTROL_MERCENARIES_MANAGER", CONTROL_MERCENARIES_MANAGER) //bluepotato
