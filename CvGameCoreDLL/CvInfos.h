...
public:
	...
	static void resetAsked(); //bluepotato
...
public:
	...
	bool isStabilityVassalBonus() const;
	bool isStabilityFoundBonus() const;
	bool isStabilityConquestBonus() const;
	bool isStabilityCommerceBonus() const;
	//bluepotato end
...
protected:
	...
	//bluepotato start (from Rhye)
	bool m_bStabilityVassalBonus;
	bool m_bStabilityFoundBonus;
	bool m_bStabilityConquestBonus;
	bool m_bStabilityCommerceBonus;
	//bluepotato end
...
/************************************************************************************************/
	...
	int getNewCityFreePopulation() const; //bluepotato
...
/* UNOFFICIAL_PATCH                        END                                                  */
/************************************************************************************************/
	int newCityFreePopulation; //bluepotato
};
...
public:
	...
	//bluepotato start
	std::wstring getRFCID() const;
	void setPlayable(bool playable);
	void setAIPlayable(bool playable);
	//bluepotato end
	// Arrays
