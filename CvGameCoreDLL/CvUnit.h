...
public:
	...
	void reloadEntity();
	void init(int iID, UnitTypes eUnit, UnitAITypes eUnitAI, PlayerTypes eOwner, int iX, int iY, DirectionTypes eFacingDirection, int newMaintenanceCost = 0); //bluepotato: merc maintenance
	void uninit();
